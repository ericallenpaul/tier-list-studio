...
- [Windows x64 installer](https://github.com/ericallenpaul/tier-list-studio/releases/download/v0.1.0/Tier.List.Studio-0.1.0-win-x64.exe)
- [Linux x64 AppImage](https://github.com/ericallenpaul/tier-list-studio/releases/download/v0.1.0/Tier.List.Studio-0.1.0-linux-x86_64.AppImage)
